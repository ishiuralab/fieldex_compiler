...
sub _func_list {
    ...
    for my $func ( @$func_list ){
        ...
        # $s .= $indent2 . "'t_var_start'=>$func->{t_var_start}," . $n;
        # $s .= $indent2 . "'t_var_end'=>$func->{t_var_end}," . $n;
        ...
        # $s .= $indent2 . "'called'=>'$func->{called}'," . $n;
        ...
        if (defined $func->{struct_args_flag}) {
          $s .= $indent2 . "'struct_args_flag'=>'$func->{struct_args_flag}'," . $n;
        }
        $s .= $indent1 . '},' . $n;
    }
  ...
  # print Dumper $ref;
    ...
    if ( $ref->{ntype} eq 'op' ) {
      if ($ref->{otype} eq 'a') {
        ...
        # if (defined $ref->{var}->{replace_flag}) {
